...
export default function DashboardPage() {
  ...
  // Agrupar tareas de amigos por usuario
    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#0A0A0B", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <main style={{ flex: 1, padding: "32px 36px", overflowY: "auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 32 }}>
          <div>
            <div style={{ fontSize: 11, color: "#555", fontFamily: "'Space Mono', monospace", marginBottom: 6, letterSpacing: "0.1em" }}>
              {new Date().toLocaleDateString("es-CR", { weekday:"long", day:"numeric", month:"long" }).toUpperCase()}
            </div>
            <h1 style={{ fontSize: 30, fontWeight: 800, color: "#fff", margin: 0, letterSpacing: "-0.03em" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14, marginBottom: 28 }}>
              {[
                ...
                <div key={s.label} style={{
                  ...
                  <div style={{ fontSize: 11, color: "#555", fontFamily: "'Space Mono', monospace", marginBottom: 8, letterSpacing: "0.08em" }}>{s.label}</div>
